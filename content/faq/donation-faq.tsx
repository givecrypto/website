export default [
  ...
  {
    question: `What happens if I donate via Ripple?`,
    answer: `If you would like to donate in Ripple, just click the “Donate Crypto” option on our site and select the Donate Ripple. Right now anonymous Ripple donations are the only option enabled. We hope to activate donation receipts for Ripple donors in the near future.`
  },
  {
